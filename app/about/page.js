                    ...
                    <div class="flex flex-wrap -m-4">
                        <div class="p-4 lg:w-1/4 md:w-1/2">
                            <div class="h-full flex flex-col items-center text-center">
                                <Image width={200} height={200} alt="team" class="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4" src="https://github.com/parthiv2406.png" />
                                <div class="w-full">
                                    <h2 class="title-font font-medium text-lg text-gray-900">Parthiv Das Mandal</h2>
                        ...
                        <div class="p-4 lg:w-1/4 md:w-1/2">
                            <div class="h-full flex flex-col items-center text-center">
                                <Image width={200} height={200} alt="team" class="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4" src="https://github.com/ritesh2004.png" />
                                <div class="w-full">
                                    <h2 class="title-font font-medium text-lg text-gray-900">Ritesh Pramanik</h2>
                        ...
                        <div class="p-4 lg:w-1/4 md:w-1/2">
                            <div class="h-full flex flex-col items-center text-center">
                                <Image width={200} height={200} alt="team" class="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4" src="https://github.com/Shouvik2.png" />
                                <div class="w-full">
                                    <h2 class="title-font font-medium text-lg text-gray-900">Shouvik Pramanik</h2>
                        ...
                        <div class="p-4 lg:w-1/4 md:w-1/2">
                            <div class="h-full flex flex-col items-center text-center">
                            <Image width={200} height={200} alt="team" class="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4" src="https://github.com/moh-15.png" />

                                <div class="w-full">
                                    <h2 class="title-font font-medium text-lg text-gray-900">Mohana Mukhopadhyay</h2>
